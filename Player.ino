...
void drawPlayer()
{
  ...
  if(player.hp>0)
  {
    if(player.etat<0.5)
    {
      drawBitmapAngle(42,player.y, HelicoGauche,HelicoGaucheMask,  player.angleSprite);
      drawMitraille((0.90 + player.angleSprite),-1);
    }
    else if(player.etat>2.5)
    {
      drawBitmapAngle(42,player.y, HelicoDroite,HelicoDroiteMask,player.angleSprite);
      drawMitraille(0.90 - player.angleSprite,1);
    }
    else
    {
      drawBitmapAngle(42,player.y, HelicoFace,HelicoFaceMask,player.angleSprite);
      drawMitraille(0,1);
    }
  }
  else if(player.y<42)
  {
    drawBitmapAngle(42,player.y, HelicoExplode,HelicoExplodeMask,player.angleSprite);
  }
  else
  {
    drawBitmapAngle(42,34, HelicoCrache,HelicoCracheMask,0);
  }
}
